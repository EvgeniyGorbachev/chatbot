        ...
        smooch.apps.create({
            ...
            request(options, function(error, response, body) {
                ...
                if (error) {
                    ...
                    return res.render('campaigns_edit', {
                        errSmooch: 'Smooch: Can not create key and secret for App'
                    })
                }
                ...
                if (campaign.channel == 'sms') {
                    ...
                    return res.render('campaigns_edit', {
                        errSmooch: 'Unsupported channel type'
                    })
                }
                ...
                smooch.integrations.create(campaign.smooch_app_id, integrationData).then((response) => {
                    ...
                    smooch.webhooks.create(campaign.smooch_app_id, {
                        ...
                        smooch.webhooks.create(campaign.smooch_app_id, {
                            ...
                            return res.render('campaigns_edit', {
                                errSmooch: 'Smooch: Can not add Webhook for WebChat UI'
                            })
                        })
                        ...
                        return res.render('campaigns_edit', {
                            errSmooch: 'Smooch: Can not add Webhook for chatbot(AWS Lambda)'
                        })
                    })
                }).catch(function(err) {
                    console.log(22222, err)
                    return res.render('campaigns_edit', {
                        errSmooch: 'Smooch: Can not create Twilion integration'
                    })
                })
            })
        }).catch(function(err) {
            ...
            return res.render('campaigns_edit', {
                errSmooch: 'Smooch: Can not create an App'
            })
        })
    }
};
