...
describe('Class processMessage', () =>
{
    ...
    describe('Step 3', () =>
    {
        ...
        it('Should be rejected on step 3 because wait callback', () =>
        {
            return expect(processMessages.processMessage(to, phoneNumber)).to.be.rejected;
        });
    ...
    describe('Step 9', () =>
    {
        ...
        it('Should return: "As previously explained, the basic program is 3 payments of $19.95. But for an additional $19.95 per month, you can get my deluxe package. As an added bonus just for you, I’ll waive the additional shipping. Can I send this to you? [Y/N]',
            () =>
            {

                return processMessages.processMessage(to, phoneNumber, 'Y').then((data) =>
                {
                    expect(data).to.deep.equal({
                        id   : 9,
                        text: 'As previously explained, the basic program is 3 payments of $19.95. But for an additional $19.95 per month, you can get my deluxe package. As an added bonus just for you, I’ll waive the additional shipping. Can I send this to you? [Y/N]',
                        delay: 2
                    })
                })
            });
